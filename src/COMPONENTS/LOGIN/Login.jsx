...
function Login() {
  return (
    <div>
      ...
      <div className="min-h-[90vh] flex fle-col items-center justify-center py-6 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
          <div>
            ...
            <p className="text-sm mt-12 text-gray-800">Don't have an account <a href="javascript:void(0);" className="text-black-600 font-semibold hover:underline ml-1">Register here</a></p>
          </div>
          ...
          <form className="max-w-md md:ml-auto w-full">
            ...
            <div className="space-y-4">
              <div>
                <input name="email" type="email" autocomplete="email" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md  focus:bg-transparent" placeholder="Email address" />
              </div>
              <div>
                <input name="password" type="password" autocomplete="current-password" required className="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md  focus:bg-transparent" placeholder="Password" />
              </div>
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="text-sm">
                  <NavLink to="jajvascript:void(0);" className=" hover:text-gray-600 font-semibold">
            ...
            <div className="!mt-8">
              <button type="button"className="w-full shadow-xl bg-black py-2.5 px-4 text-sm font-semibold rounded text-white">
                Log in
              </button>
            </div>
