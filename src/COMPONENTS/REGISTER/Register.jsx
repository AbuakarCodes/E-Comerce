...
function Register() {
  return (
    <>
    <Navbar/>
        <div class="font-[sans-serif] bg-white max-w-4xl flex items-center mx-auto md:min-h-[90vh] p-4">
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="relative flex items-center">
                <input name="name" type="text" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" />
            ...
            <div class="flex items-center">
              ...
              <label for="remember-me" class="ml-3 block text-sm text-gray-600">
                I accept the <NavLink to="javascript:void(0);" class="text-[.7] font-semibold hover:underline ml-1">Terms and Conditions</NavLink>
              </label>
            </div>
          </div>

          <div class="mt-8">
            <button type="button" class=" transition-all duration-300 w-full py-2.5 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none">
              Create an account
            </button>
          </div>
          <p class="text-gray-600 text-sm mt-6 text-center">Already have an account? <NavLink to="javascript:void(0);" class=" text-[.7rem] font-semibold hover:underline ml-1">Login here</NavLink></p>
        </form>
      </div>
    </div>
    </>
